...
<div class='single-post-ph-wrapper'>
    <div id='phsf' class="row">

        <div class='col-md-8 content-img <?php echo $pheaderclass;?> <?php echo $is_quote ? "citation" : ""; ?>'>
    ...
    <!--				 		<div class='post-description-short'>--><?php //echo wp_trim_words( $post->post_content , 35, '...' ); ?><!--</div>-->
        ...
        <div class="col-md-4 post-content">
            <div class="post-content_header">
                <div class="post-hunted-by">
                    <div class="aside-hunt">
                        <section class="post-people">
                            ...
                            <a class="post-day" href="<?php echo get_post_permalink($post->ID); ?>">
                            ...
                            <span class='ph_em ph_ft hide'>
                                      <div class="who-by-e flag-drop votes-inner">
                                        <span class="drop-target drop-theme-arrows-bounce"><i class="fa fa-flag"></i></span>
                ...
                <div class="post-save-get">
                    <a class="ph-collect-single post-button" href="#" title="Save to your collections" data-pid ='<?php echo $post->ID;?>'>
                        <svg class='svg-collect' width="15" height="14" viewBox="0 0 15 14" xmlns="http://www.w3.org/2000/svg"><path d="M13 10V8.99c0-.54-.448-.99-1-.99-.556 0-1 .444-1 .99V10H9.99c-.54 0-.99.448-.99 1 0 .556.444 1 .99 1H11v1.01c0 .54.448.99 1 .99.556 0 1-.444 1-.99V12h1.01c.54 0 .99-.448.99-1 0-.556-.444-1-.99-1H13zM0 1c0-.552.447-1 .998-1h11.004c.55 0 .998.444.998 1 0 .552-.447 1-.998 1H.998C.448 2 0 1.556 0 1zm0 5c0-.552.447-1 .998-1h11.004c.55 0 .998.444.998 1 0 .552-.447 1-.998 1H.998C.448 7 0 6.556 0 6zm0 5c0-.552.453-1 .997-1h6.006c.55 0 .997.444.997 1 0 .552-.453 1-.997 1H.997C.447 12 0 11.556 0 11z" fill="#C8C0B1" fill-rule="evenodd"></path></svg>
                        <span class='post-save'><?php _e('Save','pluginhunt');?></span>
                    </a>

                    <div class='post-reddit-wrapper'>
                        <a class='post-get-it' href="<?php echo esc_url($out); ?>" title="<?php the_title_attribute(); ?>" target="_blank" rel="nofollow"><?php echo of_get_option('ph_get_it', 'découvrir'); ?></a>
                    </div>

                    <div class = 'post-reddit <?php echo $c; ?> reddit-voting-<?php echo $post->ID; ?>'>
                        <div class="post-like">
                            <span class="post-arrow fa fa-caret-up  fa-2x <?php echo $c;?> arrow-up-<?php echo $post->ID;?>" data-red-current = <?php echo $al;?> data-red-like = "up" data-red-id = "<?php echo $post->ID;?>" role="button" aria-label="upvote" tabindex="0">
                            </span>
                        </div>
                        <div class="post-score score-<?php echo $post->ID;?>" data-red-current = <?php echo $al;?>><?php echo $postvote; ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="post-title">
                <h1 class="title-link-html-<?php echo $post->ID;?>" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></h1>
            </div>
            ...
            <div class="post-categories">
                ...
                foreach($categories as $category) {
                    ...
                    if ($cat_id != 1) {
                        echo '<a class="post-category" href="' . esc_url( get_category_link( $category->term_id ) ) . '">'.$cat_name.'</a>';
                    }
                }
                ?>
            </div>
            ...
            <div class='section post-share'>
                <a class="share" href="<?php echo get_permalink($post->ID);?>" title="<?php the_title(); ?>" data-action="facebook">
                    <span class='fb'>
                        <i class="fa fa-facebook"></i>
                    </span>
                </a>
                <a class="share" href="<?php echo get_permalink($post->ID);?>" title="<?php the_title(); ?>" data-action="twitter">
                    <span class='tw'>
                        <i class="fa fa-twitter"></i>
                    </span>
                </a>
                <a class="share" href="<?php echo get_permalink($post->ID);?>" title="<?php the_title(); ?>" data-action="google">
                    <span class='gp'>
                        <i class="fa fa-google-plus"></i>
                    </span>
                </a>
                <span class='em ph-s-em share-mail' data-subject='<?php the_title(); ?>'' data-link=<?php echo get_permalink($post->ID); ?>'>
        ...
        <div class = "row post-detail col-md-8">
                 <div class='full-width-ph'>
                    <section class="ph-lhs">
                        ...
                        <div class='section-media'>
                            ...
                            $media = get_post_meta($post->ID,'phmedia',true);
                             ...
                             if(current_user_can( 'upload_files' ) && $media !='' && $current_user->ID  == $post->post_author && !wp_is_mobile()|| isSiteAdmin()){ ?>
                        ...
                        <?php if(current_user_can( 'upload_files' ) && $current_user->ID  == $post->post_author || isSiteAdmin()){ ?>
                        <?php if($media==''){ ?>
                            <div class='pm'>
        ...
        <div class='row post-another col-md-4'>
            ...
            <div class="section section-sim">
                ...
                <a class="relatedthumb" rel="external" href="<?php the_permalink()?>">
                    <span class="post-another">
