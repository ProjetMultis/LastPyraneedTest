...
class Options_Framework_Admin {
	...
	function add_custom_options_page() {
		...
		//add_submenu_page( $pluginhunt_slugs['home'], 'Waiting List', 'Waiting List', 'manage_options', $pluginhunt_slugs['waiting'] , 'pluginhunt_render_list_page' );
     ...
     */
	 ...
	 ?>
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
	    	<div id="option-tree-sub-header"><h3 class="theme-tittle">plugin hunt theme<span> options</span></h3><span class="theme-version"><?php echo $ph_version; ?></span><button class="option-tree-ui-button grey right" id='epic-form-submit-button'>Save Changes</button><div class="clear"></div></div>
		    <div id="optionsframework" class="ui-tabs">
		    	<?php echo Options_Framework_Interface::optionsframework_tabs(); ?>
		    	<div id="poststuff">
				<form action="options.php" method="post" id="epic_options_form">
				<?php settings_fields( 'optionsframework' ); ?>
				<?php Options_Framework_Interface::optionsframework_fields(); /* Settings */ ?>
				<div id="optionsframework-submit" class='option-tree-sub-footer'>
					<input type="submit" class="option-tree-ui-button grey right" name="update" value="<?php esc_attr_e( 'Save Changes', 'theme-textdomain' ); ?>" />
					<input type="submit" class="reset-button option-tree-ui-button grey right" name="reset" value="<?php esc_attr_e( 'Restore Defaults', 'theme-textdomain' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'theme-textdomain' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
				</form>
			</div>
