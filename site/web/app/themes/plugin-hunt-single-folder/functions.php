...
/*** PHP CHECK AND DIE IF NOT SUPPORTED **/
...
global $ph_version;
$ph_version = '7.5.1';  //latest release
...
$pluginhunt_slugs['guide_url']      = "https://epicthemes.com/guide/plugin-hunt-theme/feed/";
...
function pyraneed_enqueue_styles() {
  
  // enqueue parent styles
  // https://codex.wordpress.org/Function_Reference/wp_enqueue_style
  // wp_enqueue_style( $handle, $src, $deps, $ver, $media )
  wp_enqueue_style('plugin-hunt-theme', get_template_directory_uri() .'/style-pyraneed.css');
  
}
add_action('wp_enqueue_scripts', 'pyraneed_enqueue_styles');
...
function pluginhunt_home(){
  ...
  echo "<div class='home'><img src='http://pluginhunt.com/wp-content/uploads/2015/11/image_11.png'/><h1>Plugin Hunt WordPress Theme <span class='version'>" . $ph_version . "</span></h1></div>";
  ?>
  <div class='main'>
      ...
      <?php $docs = "http://epicknowledgebase.com/article-categories/plugin-hunt-theme/"; ?>
      <br/>
      <p class='button-hunt'>
        <a href= '<?php echo $docs; ?>' target='_blank'><button class='btn btn-primary btn-lg'><?php _e("Read Documentation","pluginhunt"); ?></button></a>
      </p>
  </div>
...
if (! function_exists ( 'ph_newmedia' ) ) {
...
function ph_mailchimp($action){
  ...
  <div class="newsletter-box well">
      ...
      <div style="display:block"><input name="utf8" type="hidden" value=""></div>
...
if ( ! class_exists( 'Plugin_Hunt_License_Menu' ) ) {
    ...
    require_once( get_template_directory() . '/am-license-menu.php' );
     ...
     */
    Plugin_Hunt_License_Menu::instance( __FILE__, 'Plugin Hunt Theme', $ph_version, 'theme', 'https://epicthemes.com/' );
}
