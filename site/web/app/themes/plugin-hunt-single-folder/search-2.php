...
<div class='ph-layout-2 ph-list'>
	...
	<div class='col-md-2 discuss-sidebar' style='margin-top:80px'>
...
<?php
	echo __('Results for ','ph_theme') . '<span class="search-query">'. $s . '</span><span class="nr"> ' . $NumResults . ' ' . $r . '</span></h1></div>';  
...
<div class='col-md-3 discussion-collections wp-hide' style="margin-top:52px;display:none;"">
