...
function pluginhuntbind() {
    ...
    jQuery(".comment-submit").unbind("click").bind("click", function() {
        ...
        i(".ph-newsubmit-button").unbind("click").bind("click", function(e) {
            ...
            if ("" == t && (t = "Hunting.."), jQuery(".ph-newsubmit-button").addClass("disabled").val(t), name = i("#name").val(), url = i("#url").val(), tag = i("#tagline").val(), media = pluginHuntTheme_Global.imgArray, type = i("#producttype").val(), cat = i("#cat").val(), avail = i("#postavailability").val(), discat = i("#discussioncat").val(), prod = window.phproduct, "post" == prod) {
