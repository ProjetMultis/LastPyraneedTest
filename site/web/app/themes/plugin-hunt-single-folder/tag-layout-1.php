			...
			<div class = 'row hunt-row <?php echo $blob;?>' style = 'margin-bottom:20px'>
				<div class = "reddit-voting <?php echo $c; ?>">
					<ul class="unstyled">
						...
						<div class="arrow fa fa-caret-up  fa-2x <?php echo $c;?> arrow-up-<?php echo $post->ID;?>" data-red-current = <?php echo $al;?> data-red-like = "<?php echo $redclassd; ?>" data-red-id = "<?php echo $post->ID;?>" role="button" aria-label="upvote" tabindex="0"></div>
