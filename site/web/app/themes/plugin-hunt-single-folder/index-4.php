...
<div class='container-fluid'>
	...
	<div class='col-md-3'>
		...
		<?php get_template_part('pyraneed','menu'); ?>
	...
	<div class='col-md-9 white-splash'>
	<?php
...
<div class='clear'></div>
	<a id="ph-log-social-new" href="#animatedModal" style="display:none">HELLO WORLD</a>
...
if ($pageposts): ?>
 ...
 <?php setup_postdata($post); 
			...
			$post_term = get_the_category($post->ID);
			$post_color = insert_post_color($post_term[0]->term_id);
			$is_quote = false;
			...
			<div class = 'row hunt-row <?php echo $blob;?>' style="border-right: 10px solid <?php echo $post_color;?>; background:<?php 			echo $is_quote ? "#fff" : "#fff"; ?>;">
			...
			?>
			<?php if ($is_quote): ?>
				<span class='quote-picto' style="background-image: url('<?php echo get_stylesheet_directory_uri() . "/assets/img/quote.png"; ?>')"></span>
			<?php endif ?>


			<?php if (!$is_quote|| $is_quote): ?>
			...
			<div class='ph-content-detail'>
				<div class='author-ava hide'>
						...
						<?php // if ( wp_is_mobile() ) {  echo '</a>'; }  ?>		
							 <div class='description' style="color: <?php echo $is_quote ? "#00060D": ""; ?>">
							 	<?php
						...
						<div class='low-blow'>
							<div class = "reddit-voting <?php echo $c; ?> reddit-voting-<?php echo $post->ID; ?>">
									...
									<div class="score score-<?php echo $post->ID;?>" data-red-current = <?php echo $al;?>><?php echo $postvote; ?>
									</div>
							</div>
							...
							<?php if (get_the_tags()) {?>
							<?php echo get_the_tag_list('<p class="show-tags">',' ','</p>', $post->ID); ?>
							<?php } ?>
 ...
 <?php endif; ?>
			...
			<div id='navigation'>
			    <div class='next-posts-link'>
			    	...
			    	<a href="<?php echo esc_url( home_url( '/' ) )?>?day=<?php echo $d;?>&month=<?php echo $m;?>&year=<?php echo $y;?>">next</a>s
