...
<div class="modal modal-fullscreen fade" id="modal-fullscreen" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body" id="video-ph-modal">
        <div class='col-md-6 pull-left'>
            <div class='ph-video-modal'>
            </div>
        </div>
...
<?php if(function_exists('onboardme_scripts')){ ?>
<div class='tour-wrapper-footer'><a class = 'tour-start' href="#tour"><i class="fa fa-question-circle"></i></a></div> 
<?php } ?>
