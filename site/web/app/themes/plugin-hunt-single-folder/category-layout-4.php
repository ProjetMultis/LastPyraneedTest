...
<div class='ph-layout-2 ph-list ph-cat-4'>
<?php 
...
<!-- 
bloquer comportement par défaut du JS -->

<div class='container-fluid'>
	<div class='post-wrapper' style='<?php echo $post_wrapper;?>'>
	<div class='col-md-3 discuss-sidebar'>
	...
	<div class='col-md-9 white-splashs'>
...
<?php get_template_part('pyraneed','header_cat_display'); ?>
...
<?php
	...
	setup_postdata($post); 
			...
			<div class = 'row hunt-row <?php echo $blob;?>' style="border-right: 5px solid <?php echo $post_color;?>; background:<?php 			echo $is_quote ? "#fff" : "#fff"; ?>;">
	...
	<?php if($num_posts > 10 && $paged >1){ 
			...
			<div id='navigation'>
				...
				<div class='ph-next ph-next-cats'>
					<a href="<?php echo esc_url( home_url( '/category/' . $queried_object->slug ) .'/' )?>">next</a>
				</div>
