...
<?php
    ...
    if($cid == $author_id){ ?>
<div class="collection-detail <?php echo $pheaderclass;?>" ><header class="collection-detail--header v-brown" style="background-image: url(<?php echo $image[0]; ?>);">
...
<div class="collection-detail--subnav lay3subnav" data-reactid=".3.1"><div class="collection-detail--subnav--container" ><div class="collection-detail--share-buttons"><a class="collection-detail--share-buttons--item v-twitter share" href="<?php echo get_permalink();?>" title="<?php the_title(); ?>" data-action="twitter"><span data-reactid=".3.1.0.3.0.0"><!--?xml version="1.0" encoding="UTF-8" standalone="no"?-->
