        ...
        <div class="col-xs-12">
            <div class="col-md-12">
                ...
                <div class='row ph-addon-list'>
                    ...
                    <div class='ph-addon' style="margin-top:20px;">
                        <div class='ph-img'>
                            <img src='https://epicplugins.com/wp-content/uploads/2016/12/notify-me-plugin.png'/>
                        </div>
                        <div class='ph-des'>
                        <div class='ph-title'><?php _e('Notify Me - $39.99', 'pluginhunt'); ?></div>
                            Have notifications on your website for your users. Let them know when their content is upvoted. When their content is commented on. Or when they're followed. It also notifies you when someone you
                            follow has submitted a new product. Notifications when
                          <ul class='ph-listing-list' style='list-style:disc;margin-left:380px'>
                            <li>Your Product is upvoted</li>
                            <li>Your Product is commented on</li>
                            <li>You are followed</li>
                            <li>Someone you follow posts a product</li>
                          </ul>  
                        </div>
                        <div class='ph-buy'>
                             <a href='https://epicplugins.com/product/notify-me-plugin/' target='_blank' class='button-primary'>Launch Price $29.99 Buy Now</a>
                        </div>
                    </div>
                    ...
                    <div class='ph-addon'>
                        ...
                        <div class='ph-buy'>
                             <a href='https://epicplugins.com/product/popular-this/' target='_blank' class='button-primary'>$19.99 Buy Now</a>
                        </div>
                    </div>
